function matA = stiff_matrix_dirichlet(vecMesh)
...
vecDiag(i,1) = dblInt*(1/dblH)^2 + dblInt1*(-1/dblH1)^2;
%superdiag
vecSup(i+1,1) = (-1/dblH1)*(1/dblH1)*dblInt1;
